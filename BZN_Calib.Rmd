...
BestVariab<-as.numeric(as.vector(readRDS("BestVariab_100.RDS")))
...
ggplot(deaths_chagas_disease2, aes(x = year, y = count)) +
  ...
  #geom_smooth(aes(y = count, color = "Model"), method = "lm", se = FALSE) +
  #geom_smooth(aes(y = deaths, colour = "Deaths"), method = "lm", se = FALSE) +
  labs(
