...
fig3<-ggplot(PSADAT_df, aes(x = AQALYs, y = ACosts)) +
...
# Plot CEAC
fig4<-ggplot(ceac_data, aes(x = WTP, y = CE_Probability)) +
  geom_line(color = "darkgreen", linewidth = 1) +
  ylim(0,1) +
  labs(
    title = "Cost-Effectiveness Acceptability Curve (CEAC)",
    x = "Willingness-to-pay Threshold (2025€ per QALY)",
