...
```{r}
population_over_time_t<-Simulate_t(P_card=0.01, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=5, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
### Simulating non-treatment arm
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=CaMorR, DiMorR=2, P_dig=P_dig, horizon=20)
```

### Simulating the treatment arm

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=2, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=1, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
### Simulating non-treatment arm
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=0.04, horizon=20)
```

### Simulating the treatment arm

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=0.04, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=1.25, RR_T_dig=0.88, horizon=20)
```
