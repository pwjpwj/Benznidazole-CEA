...
P_card_t<-variab_df[x, "P_card_v"]*0.49
P_dig<-variab_df[x, "P_dig_v"]
P_dig_t<-variab_df[x, "P_dig_v"]*0.88
...
population_over_time<-Simulate(P_card=variab_df[x, "P_card_v"], CaMorR=variab_df[x, "CaMorR_v"], DiMorR=variab_df[x, "DiMorR_v"], P_dig=variab_df[x, "P_dig_v"], RR_T_car=0.49, RR_T_dig=0.88, horizon=20, transition_matrices)
...
Simulate_t(P_card=P_card_v[which.min(reps_SMSE)],CaMorR=CaMorR_v[which.min(reps_SMSE)], DiMorR=DiMorR_v[which.min(reps_SMSE)],P_dig=P_dig_v[which.min(reps_SMSE)], RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
# Simulation loop
