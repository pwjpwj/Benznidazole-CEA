...
```{r}
population_over_time_t<-Simulate_t(P_card=0.03, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
## low value
```{r}
population_over_time<-Simulate(P_card=0.001, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, horizon=20)
```

```{r}
population_over_time_t<-Simulate_t(P_card=0.001, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
### Simulating non-treatment arm
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=3, DiMorR=DiMorR, P_dig=P_dig, horizon=20)
```

### Simulating the treatment arm

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=3, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=1.1, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
### Simulating non-treatment arm
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=CaMorR, DiMorR=2.91, P_dig=P_dig, horizon=20)
```

### Simulating the treatment arm

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=2.91, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
## low value
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=CaMorR, DiMorR=1.5, P_dig=P_dig, horizon=20)
```

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=1.5, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
### Simulating non-treatment arm
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=0.035, horizon=20)
```

### Simulating the treatment arm

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=0.035, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
## low value
```{r}
population_over_time<-Simulate(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=0.008, horizon=20)
```

```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=0.008, RR_T_car=0.49, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=1.00, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.19, RR_T_dig=0.88, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=1, horizon=20)
```
...
```{r}
population_over_time_t<-Simulate_t(P_card=P_card, CaMorR=CaMorR, DiMorR=DiMorR, P_dig=P_dig, RR_T_car=0.49, RR_T_dig=0.55, horizon=20)
```
